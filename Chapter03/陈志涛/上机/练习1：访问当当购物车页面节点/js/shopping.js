...
function accounts(){
    ...
    var book1=obj.firstElementChild.firstElementChild.nextElementSibling.nextElementSibling.innerHTML;
    var book2=obj.firstElementChild.nextElementSibling.firstElementChild.nextElementSibling.nextElementSibling.innerHTML;
    var zong=obj.lastElementChild.firstElementChild.innerHTML;
    document.getElementById("zong").innerHTML="您本次购买的商品信息如下：<br>" +
        "白岩松：白说："+book1+"<br>" +
        "岛上书店："+book2+"<br>" +
        "商品共计："+zong;
}